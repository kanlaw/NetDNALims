...
namespace CustomControls {
    ...
    public class CustomScrollbar : UserControl {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //draw channel
            e.Graphics.FillRectangle(oBrush, new Rectangle(1, UpArrowImage.Height, this.Width - 2, (this.Height - DownArrowImage.Height-UpArrowImage.Height)));
            ...
            nTop += UpArrowImage.Height;
            //int nTop = 0;
            e.Graphics.DrawImage(ThumbTopImage, new Rectangle(1, nTop- UpArrowImage.Height, this.Width - 2, ThumbTopImage.Height));

            nTop += ThumbTopImage.Height;
            int middleHeight = nSpanHeight * 2 + ThumbMiddleImage.Height+ ThumbTopImage.Height;
            e.Graphics.DrawImage(ThumbMiddleImage, new Rectangle(1, nTop- ThumbTopImage.Height, this.Width - 2, middleHeight+ ThumbTopImage.Height * 3));
