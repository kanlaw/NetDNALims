...
namespace NetDLims.Controls
{
    public class ImageComboBox : ComboBox
    {
        ...
        private Color _arrowColor = Color.DarkGray;
        private bool _bPainting;

        private Color enableColor=Color.White;

        [Browsable(true), Description("Enable=false时 背景色")]
            ...
            RightToLeft rightToLeft)
        {
            ...
            if (backgroundImageLayout == ImageLayout.Tile)
            {
                using (TextureBrush brush = new TextureBrush(backgroundImage, WrapMode.Tile))
                {
                    ...
                    {
                     System.Drawing.Drawing2D.Matrix transform = brush.Transform;
