...
using JustLib.Controls.Internals;
...
namespace JustLib.Controls
{
    ...
    public class ChatBox : RichTextBox
    {
        ...
        /// 在现有内容后面追加富文本。
        /// </summary>      
        public void AppendRichText(string textContent, Font font, Color color,string userID, string mineID, string friendID)
        {
            try
            {
                ...
                //this.InsertImage(Resources.Head_portrait02_index_32, this.SelectionStart);
                //this.AppendText("\n");
