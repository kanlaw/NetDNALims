...
namespace JustLib.UnitViews
{
    public partial class GroupListBox : UserControl
    {
        ...
        /// 选中列表
        /// </summary>
        public SkinContextMenuStrip SkinContextMenuStrip_Group {
            get {
              return  this.skinContextMenuStrip_Group;
            }
            set => this.skinContextMenuStrip_Group = value;
        }
        public ChatListBox ChatListBox_group
        {
            get {
                return this.chatListBox_group;
            }
        }
        ...
        public void Initialize(IUser current, string _companyGroupID)
        {
