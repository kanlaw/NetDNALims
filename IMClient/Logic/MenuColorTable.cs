...
namespace RX.DNA.LimsClient.UI.Controls
{
    public class MenuColorTable
    {
        ...
        private static readonly Color _borderColor = Color.FromArgb(168, 200, 216);
        private static readonly Color _backColorNormal = Color.FromArgb(255, 255, 255);
        private static readonly Color _backColorHover = Color.FromArgb(64, 178, 227);
        private static readonly Color _backColorPressed = Color.FromArgb(51, 166, 215);
        private static readonly Color _foreColor = Color.FromArgb(58, 114, 144);
