...
namespace RX.DNA.LimsClient.UI.Controls
{
    ...
    {
        private MenuColorTable _colorTable;
        ...
        public ToolStripRendererEx(MenuColorTable colorTable)
            : base()
        {
            _colorTable = colorTable;
        }

        protected virtual MenuColorTable ColorTable
        {
            get 
            {
                if (_colorTable == null)
                {
                    _colorTable = new MenuColorTable();
                }
                return _colorTable;
            }
        }
        ...
        private Color GetRollColor(Color srccolor)
        {
            return Color.FromArgb(255 - srccolor.R, 255 - srccolor.G, 255 - srccolor.B);
        }
