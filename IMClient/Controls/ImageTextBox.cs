...
namespace IMClient.Controls
{
    ...
    public class ImageTextBox : TextBox
    {
        ...
        private Color _selected_bordercolor = Color.FromArgb(0, 0, 0);
        ...
        [Browsable(true), DefaultValue(typeof(Color), "0,0,0")]
        //[DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Hidden)]
        public Color SelectedBordercolor
        {
            get { return _selected_bordercolor; }
            set
            {
                if (_selected_bordercolor != value)
                {
                    _selected_bordercolor = value;
                    base.Invalidate();
                }
            }
        }
        ...
        private void WmPaint(ref Message m)
        {
            ...
            using (Graphics graphics = Graphics.FromHwnd(base.Handle))
            {
                ...
                {
                    //边框Width为1个像素 
                    Color penColor = this.Bordercolor;
                    if (this.Focused)
                    {
                        penColor = this._selected_bordercolor;
                    }
                    System.Drawing.Pen pen = new Pen(penColor, 1);
                    //绘制边框 
