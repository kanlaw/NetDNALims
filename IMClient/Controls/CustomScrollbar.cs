...
namespace IMClient.Controls
{
    ...
    public class CustomScrollbar : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //float fSpanHeight = (fThumbHeight - (ThumbMiddleImage.Height + ThumbTopImage.Height + ThumbBottomImage.Height));
            ...
            //e.Graphics.DrawImage(ThumbTopSpanImage, 1.0f, (float)nTop, (float)this.Width - 2.0f, (float)fSpanHeight);
            ...
            //rect = new Rectangle(1, nTop, this.Width - 2, nSpanHeight);
