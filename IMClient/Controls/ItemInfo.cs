...
namespace IMClient.Controls
{
    public class ItemInfo : ItemBase
    {
        ...
        //获取三角图标
        private Image triangle = Resources.Triangle_more;
        ...
        //文字右
        private string itemstrTitleZW;

        public string ItemstrTitleZW
        {
            get { return itemstrTitleZW; }
            set { itemstrTitleZW = value; }
        }
        ...
        //文字颜色刷右
        private SolidBrush itemFontColor3;

        public SolidBrush ItemFontColor3
        {
            get { return itemFontColor3; }
            set { itemFontColor3 = value; }
        }
        ...
        //文字样式右
        private Font itemFont3;

        public Font ItemFont3
        {
            get { return itemFont3; }
            set { itemFont3 = value; }
        }
        ...
        private void PaintTitle(PaintEventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(itemstrTitleT))
            {
                ...
                RectangleF TextRect3 = new RectangleF(180, 5, Width - spos, Height / 2);
                //绘制文字(右)、指定文字格式
                e.Graphics.DrawString(itemstrTitleZW, itemFont3, itemFontColor3, TextRect3, sf);
