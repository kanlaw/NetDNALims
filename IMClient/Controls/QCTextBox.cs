...
{
    public partial class QCTextBox : TextBox
    {
        ...
        {
            using (Pen highLightPen = new Pen(Color.Black))
            {
                g.DrawRectangle(highLightPen, new Rectangle(ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width - 1, ClientRectangle.Height - 1));
        ...
        {
            using (Pen focusedBorderPen = new Pen(Color.Red))
            {
        ...
        {
            using (Pen focusedBorderPen = new Pen(Color.Green))
            {
                g.DrawRectangle(focusedBorderPen, new Rectangle(ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width - 1, ClientRectangle.Height - 1));
                g.DrawPath(focusedBorderPen, DrawHelper.DrawRoundRect(ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width - 1, ClientRectangle.Height - 1, _radius));
                //g.DrawPath(focusedBorderPen, DrawHelper.DrawRoundRect(ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width - 1, ClientRectangle.Height - 1, _radius));
        ...
        {
            using (Pen disabledPen = new Pen(ColorTable.QQBorderColor))
            {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            //Rectangle r = new Rectangle(50, 25, 15, 15);
            //DrawHelper.DrawRect(g, Resources.analy_result_small, r, 1, 1);
            //DrawHelper.DrawRect(g, Resources.analy_result_small, r, r, 1, 1);
